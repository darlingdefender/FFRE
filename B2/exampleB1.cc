...
int main(int argc,char** argv)
{
  ...
  auto* runManager =
    G4RunManagerFactory::CreateRunManager(
      singleFuelParticleView ? G4RunManagerType::SerialOnly
  ...
  if (singleFuelParticleView) {
    ...
    G4cout
      << "[Visualization] Single fuel particle view: using serial run "
         "manager and lightweight EM/decay physics only."
      << G4endl;
  } else {
