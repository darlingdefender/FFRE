...
void EventAction::BeginOfEventAction(const G4Event*)
{
  ...
  fFuelBedHydrogenEdep = 0.;
  fFuelBedHydrogenPzIn = 0.;
  fFuelBedHydrogenPzOut = 0.;
  fFuelBedHydrogenExitEnergy = 0.;
  fFuelBedHydrogenExitSpeed = 0.;
  fFuelBedHydrogenExitSpeed2 = 0.;
  fFuelBedHydrogenExitCosTheta = 0.;
  fNFuelBedHydrogenEntries = 0;
  fNFuelBedHydrogenExits = 0;
...
void EventAction::EndOfEventAction(const G4Event* event)
{
  ...
  fRunAction->AddEventFuelBedHydrogenStats(fFuelBedHydrogenEdep,
                                           fNFuelBedHydrogenEntries,
                                           fNFuelBedHydrogenExits,
                                           fFuelBedHydrogenPzIn,
                                           fFuelBedHydrogenPzOut,
                                           fFuelBedHydrogenExitEnergy,
                                           fFuelBedHydrogenExitSpeed,
                                           fFuelBedHydrogenExitSpeed2,
                                           fFuelBedHydrogenExitCosTheta);
  ...
  if (fPrintEventSummaries &&
    ...
    G4cout
      ...
      << ", H2 edep = " << fFuelBedHydrogenEdep/MeV
      << " MeV"
      << G4endl;
